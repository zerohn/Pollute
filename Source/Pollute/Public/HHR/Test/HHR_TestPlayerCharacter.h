...
#include "HHR_TestPlayerCharacter.generated.h"

UCLASS()
class POLLUTE_API AHHR_TestPlayerCharacter : public ATP_ThirdPersonCharacter , public ILCU_InteractInterface
{
	GENERATED_BODY()

public:
	// Sets default values for this character's properties
	AHHR_TestPlayerCharacter();
...
private:
	...
	// 최종 선택된 액터를 관리하는 변수
	UPROPERTY()
	class ALCU_PlayerCharacter* FinalOverapPlayer;
	UPROPERTY()
